...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    // Update the appointment status and associate admin_id if approved
    ...
    // If approved, include admin_id; if denied, do not associate admin_id
    if ($action === 'approve') {
        $updateStmt->bind_param("sii", $newStatus, $adminId, $appointmentId);
    } else {
